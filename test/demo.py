...
from mcq_gen.src.generator.retrieval import MCQGenRAG
from mcq_gen.src.generator.retrieval import MCQGenRAG
...
def test_document_ingestion_and_rag():
    ...
    query =  prompt  #  "give me 5 mcq questions from the data"
...
def test_document_ingestion_and_rag():
    ...
    index = str(ci.faiss_dir)
    mgr = MCQGenRAG(session_id=session_id)
    ...
    # 1. Build your retriever (from your ChatIngestor)
    ci_retriever = ci.build_retriever(uploaded_files, k=5)
    mgr_retriever = mgr.load_retriever_from_faiss(index)
